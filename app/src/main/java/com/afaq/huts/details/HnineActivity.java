...
import com.afaq.huts.databinding.ActivityHnineBinding;
import com.afaq.huts.model.BreakfastClass;
import com.afaq.huts.ui.CartsActivity;

import java.util.ArrayList;

public class HnineActivity extends AppCompatActivity {

    private ActivityHnineBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHnineBinding.inflate(getLayoutInflater());
        ...
        list.add(new BreakfastClass("Chicken achari", "180", R.drawable.chickenachari));
        ...
        binding.btncart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HnineActivity.this, CartsActivity.class));
            }
        });
